import { arrowVariants } from "./Arrow.variant";
...
export const ArrowPointingSvg = ({ width = 20, height = 20, color = "#858CA3", className, direction }: ArrowPointingSvgProps) => {

    return (
        <svg width={width} height={height}  viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" className={`${className} ${arrowVariants({direction})} `}>
